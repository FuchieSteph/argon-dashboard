...
(function () {
   ...
   *   https://datatables.net/download/#bs5/dt-1.13.1/kt-2.8.0/rg-1.3.0/sc-2.0.7
   *
   * Included libraries:
   *  DataTables 1.13.1, KeyTable 2.8.0, RowGroup 1.3.0, Scroller 2.0.7
   */
  ...
  !function (n) {
    ...
    var Ie = [],
      ...
      He = (e("columns()", function (n, a) {
        ...
        buttons: {},
        classes: {},
        builder: "bs5/dt-1.13.1/kt-2.8.0/rg-1.3.0/sc-2.0.7",
        errMode: "alert",
        feature: [],
        search: [],
        selector: {
  ...
  !function (t) {
    ...
    }) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = function (e, a) {
    ...
    return x.extend(!0, o.defaults, {
      ...
      function u(e, a) {
        for (var t, n, r = function r(e) {
          ...
          if (n = a[s], Array.isArray(n)) u(e, n);else {
            switch (f = p = "", n) {
              case "ellipsis":
                p = "&#x2026;", f = "disabled";
                break;
  ...
  !function (n) {
    ...
    }) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = function (e, t) {
    ...
    function o(e, t) {
      ...
      if (this.c = c.extend(!0, {}, l.defaults.keyTable, o.defaults, t), this.s = {
        ...
        tabInput: null
      }, this.dom = {}, t = this.s.dt.settings()[0], e = t.keytable) return e;
    ...
    return c.extend(o.prototype, {
      ...
      _constructor: function _constructor() {
        ...
        var i,
          ...
          n = ("static" === e.css("position") && e.css("position", "relative"), c(s.table().body()).on("click" + l, "th, td", function (e) {
            ...
            c(e.target).parents(".dataTables_filter").length && o._blur(), c(e.target).parents().filter(s.table().container()).length || c(e.target).parents("div.DTE").length || c(e.target).parents("div.editor-datetime").length || c(e.target).parents("div.dt-datetime").length || c(e.target).parents().filter(".DTFC_Cloned").length || o._blur();
            ...
            var t, n, i;
            o._tabInput(), o.s.focusDraw || o.s.lastFocus && (t = o.s.lastFocus.relative, n = s.page.info(), i = t.row + n.start, 0 !== n.recordsDisplay) && (i >= n.recordsDisplay && (i = n.recordsDisplay - 1), o._focus(i, t.column, !0, e));
          }), this.c.clipboard && this._clipboard(), s.on("destroy" + l, function () {
            o._blur(!0), s.off(l), c(s.table().body()).off("click" + l, "th, td").off("dblclick" + l, "th, td"), c(d).off("mousedown" + l).off("keydown" + l).off("copy" + l).off("paste" + l);
          }), s.state.loaded());
      ...
      _editor: function _editor(e, t, n) {
        var i, s, o, l, a, r;
        !this.s.lastFocus || t && "draw" === t.type || (s = (i = this).s.dt, o = this.c.editor, l = this.s.lastFocus.cell, a = this.s.namespace + "e" + h++, c("div.DTE", l.node()).length) || null !== e && (0 <= e && e <= 9 || 11 === e || 12 === e || 14 <= e && e <= 31 || 112 <= e && e <= 123 || 127 <= e && e <= 159) || (t && (t.stopPropagation(), 13 === e) && t.preventDefault(), r = function r() {
          var e = i._inlineOptions(l.index());
          o.one("open" + a, function () {
            o.off("cancelOpen" + a), n || c("div.DTE_Field_InputControl input, div.DTE_Field_InputControl textarea").select(), s.keys.enable(n ? "tab-only" : "navigation-only"), s.on("key-blur.editor", function (e, t, n) {
              "submit" !== o.s.editOpts.onBlur && o.displayed() && n.node() === l.node() && o.submit();
            }), n && c(s.table().container()).addClass("dtk-focus-alt"), o.on("preSubmitCancelled" + a, function () {
              setTimeout(function () {
                i._focus(l, null, !1);
              }, 50);
      ...
      _inlineOptions: function _inlineOptions(e) {
        ...
        if (i = i || null, this.s.enable) {
          if ("number" != typeof e) {
            ...
            if (t = r.column, (e = o.rows({
              filter: "applied",
              order: "applied"
            }).indexes().indexOf(r.row)) < 0) return;
            l.serverSide && (e += l.start);
          }
          if (-1 !== l.length && (e < l.start || e >= l.start + l.length)) this.s.focusDraw = !0, this.s.waitingForDraw = !0, o.one("draw", function () {
            s.s.focusDraw = !1, s.s.waitingForDraw = !1, s._focus(e, t, f, i);
          }).page(Math.floor(e / l.length)).draw(!1);else if (-1 !== c.inArray(t, this._columns())) {
            l.serverSide && (e -= l.start);
            r = o.cells(null, t, {
              search: "applied",
              order: "applied"
            }).flatten(), l = o.cell(r[e]);
            if (a) {
            ...
            r = c(l.node());
            r.addClass(this.c.className), this._updateFixedColumns(t), n !== f && !0 !== n || (this._scroll(c(u), c(d.body), r, "offset"), (a = o.table().body().parentNode) !== o.table().header().parentNode && (n = c(a.parentNode), this._scroll(n, n, r, "position"))), this.s.lastFocus = {
              cell: l,
              node: l.node(),
              relative: {
                row: o.rows({
            ...
            }, this._emitEvent("key-focus", [this.s.dt, l, i || null]), o.state.save();
          }
        }
      },
      _key: function _key(n) {
        if (this.s.waitingForDraw) n.preventDefault();else {
          var e = this.s.enable,
          ...
          if (e && (!(0 === n.keyCode || n.ctrlKey || n.metaKey || n.altKey) || n.ctrlKey && n.altKey)) {
            ...
            if (i) if (this.s.dt.cell(i.node).any()) {
              var s = this,
                o = this.s.dt,
                l = !!this.s.dt.settings()[0].oScroll.sY;
              if (!this.c.keys || -1 !== c.inArray(n.keyCode, this.c.keys)) switch (n.keyCode) {
                case 9:
                  n.preventDefault(), this._keyAction(function () {
      ...
      _keyAction: function _keyAction(e) {
      ...
      _scroll: function _scroll(e, t, n, i) {
        var s = n[i](),
          o = n.outerHeight(),
          l = n.outerWidth(),
          a = t.scrollTop(),
          ...
          c = e.height(),
          e = e.width();
        "position" === i && (s.top += parseInt(n.closest("table").css("top"), 10)), s.top < a && t.scrollTop(s.top), s.left < r && t.scrollLeft(s.left), s.top + o > a + c && o < c && t.scrollTop(s.top + o - c), s.left + l > r + e && l < e && t.scrollLeft(s.left + l - e);
      },
      _shift: function _shift(e, t, n) {
        var i,
          s = this.s.dt,
          o = s.page.info(),
          l = o.recordsDisplay,
      ...
      _updateFixedColumns: function _updateFixedColumns(e) {
        var t,
          n = this.s.dt,
          i = n.settings()[0];
      ...
      keys: null,
      tabIndex: null
    }, o.version = "2.8.0", c.fn.dataTable.KeyTable = o, c.fn.DataTable.KeyTable = o, l.Api.register("cell.blur()", function () {
  ...
  !function (n) {
    "function" == typeof define && define.amd ? define(["jquery", "datatables.net-bs5", "datatables.net-keytable"], function (e) {
      ...
      return e = e || window, (t = t || ("undefined" != typeof window ? require("jquery") : require("jquery")(e))).fn.dataTable || require("datatables.net-bs5")(e, t), t.fn.dataTable || require("datatables.net-keytable")(e, t), n(t, 0, e.document);
    } : n(jQuery, window, document);
  }(function (e, t, n, a) {
  ...
  !function (e) {
    ...
    }) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = function (t, r) {
      return t = t || window, (r = r || ("undefined" != typeof window ? require("jquery") : require("jquery")(t))).fn.dataTable || require("datatables.net")(t, r), e(r, 0, t.document);
    ...
    return a.extend(s.prototype, {
      ...
      _group: function _group(t, r) {
        ...
        if (n[t + 1] !== l) for (i = 0, u = s.length; i < u; i++) {
          s[i].children = this._group(t + 1, s[i].rows);
        }
        return s;
      },
      _groupDisplay: function _groupDisplay(t, r) {
      ...
      _rowWrap: function _rowWrap(t, r, e) {
        return (t = null !== t && "" !== t ? t : this.c.emptyDataGroup) === l || null === t ? null : ("object" == _typeof(t) && t.nodeName && "tr" === t.nodeName.toLowerCase() ? a(t) : t instanceof a && t.length && "tr" === t[0].nodeName.toLowerCase() ? t : a("<tr/>").append(a("<th/>").attr("colspan", this._colspan()).attr("scope", "row").append(t))).addClass(this.c.className).addClass(r).addClass("dtrg-level-" + e);
      }
    }), s.defaults = {
      ...
      startRender: function startRender(t, r) {
        return r;
      }
    }, s.version = "1.3.0", a.fn.dataTable.RowGroup = s, a.fn.DataTable.RowGroup = s, p.Api.register("rowGroup()", function () {
      return this;
  ...
  !function (n) {
    "function" == typeof define && define.amd ? define(["jquery", "datatables.net-bs5", "datatables.net-rowgroup"], function (e) {
      ...
      return e = e || window, (t = t || ("undefined" != typeof window ? require("jquery") : require("jquery")(e))).fn.dataTable || require("datatables.net-bs5")(e, t), t.fn.dataTable || require("datatables.net-rowgroup")(e, t), n(t, 0, e.document);
    } : n(jQuery, window, document);
  }(function (e, t, n, r) {
    return e.fn.dataTable;
  });
  ...
  */
  ...
  $jscomp.polyfillIsolated = function (c, f, g, h) {
    ...
    null != f && (c ? $jscomp.defineProperty($jscomp.polyfills, l, {
      ...
      writable: !0,
      value: f
    }) : f !== g && ($jscomp.propertyToPolyfillSymbol[l] = $jscomp.IS_SYMBOL_NATIVE ? $jscomp.global.Symbol(l) : $jscomp.POLYFILL_PREFIX + l, l = $jscomp.propertyToPolyfillSymbol[l], $jscomp.defineProperty(h, l, {
      configurable: !0,
      writable: !0,
      value: f
    })));
  ...
  (function (c) {
    ...
    c.extend(m.prototype, {
      ...
      pixelsToRow: function pixelsToRow(a, b, d) {
      ...
      rowToPixels: function rowToPixels(a, b, d) {
        a -= this.s.baseRowTop;
      ...
      scrollToRow: function scrollToRow(a, b) {
        ...
        0 > n && (n = 0);
        (k > this.s.redrawBottom || k < this.s.redrawTop) && this.s.dt._iDisplayStart !== n && (e = !0, k = this._domain("virtualToPhysical", a * this.s.heights.row), this.s.redrawTop < k && k < this.s.redrawBottom && (this.s.forceReposition = !0, b = !1));
      ...
      construct: function construct() {
        ...
        if (this.s.dt.oFeatures.bPaginate) {
          ...
          b.on("stateSaveParams.scroller", function (k, n, p) {
            d && e ? (p.scroller = e.scroller, d = !1, p.scroller && (a.s.lastScrollTop = p.scroller.scrollTop)) : p.scroller = {
      ...
      _calcRowHeight: function _calcRowHeight() {
        ...
        var n = c("tr", e).length;
        if (1 === n) e.prepend("<tr><td>&#160;</td></tr>"), e.append("<tr><td>&#160;</td></tr>");else for (; 3 > n; n++) {
      ...
      _info: function _info() {
        if (this.s.dt.oFeatures.bInfo) {
          ...
          e = a.aanFeatures.i;
          if ("undefined" != typeof e) for (k = 0, n = e.length; k < n; k++) {
            c(e[k]).html(p);
          }
      ...
      _scroll: function _scroll() {
        ...
        if (!this.s.skip && !this.s.ingnoreScroll && d !== this.s.lastScrollTop) if (this.s.dt.bFiltered || this.s.dt.bSorted) this.s.lastScrollTop = 0;else {
          ...
          if (this.s.forceReposition || d < this.s.redrawTop || d > this.s.redrawBottom) {
            ...
            this.s.targetTop = e;
            e != this.s.dt._iDisplayStart && (this.s.tableTop = c(this.s.dt.nTable).offset().top, this.s.tableBottom = c(this.s.dt.nTable).height() + this.s.tableTop, e = function e() {
          ...
          this.s.labelVisible && (b = (b.viewport - b.labelHeight - b.xbar) / b.scroll, this.dom.label.html(this.s.dt.fnFormatNumber(parseInt(this.s.topRowFloat, 10) + 1)).css("top", d + d * b).css("right", 10 - this.dom.scroller.scrollLeft).css("display", "block"));
        }
      },
  ...
  */
  (function (c) {
    "function" === typeof define && define.amd ? define(["jquery", "datatables.net-bs5", "datatables.net-scroller"], function (a) {
